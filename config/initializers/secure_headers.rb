SecureHeaders::Configuration.configure do |config|
  ...
  config.csp = {
  	default_src: 'self',
  	script_src: 'self https://ssl.google-analytics.com http://owaspappseccalifornia2014.sched.org https://www.google-analytics.com https://platform.twitter.com https://*.twimg.com',
