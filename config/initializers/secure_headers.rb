SecureHeaders::Configuration.configure do |config|
  config.csp = {
  	...
  	:frame_src => 'https: https://cloudfront.net https://www.youtube.com http://www.youtube.com http://*.twitter.com https://*.twitter.com https://twitter.com http://twitter.com https://maps.google.com http://maps.google.com',
